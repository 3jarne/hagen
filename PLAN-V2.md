...
- Del opp store filer etter eget skjønn
- Fix global stilverdi-bug

**Test:**
- Sett farge til rød → klikk eksisterende element → fargen endres IKKE
- Tegn nytt element → det er rødt
- Alle v1-funksjoner fungerer som før
...
- Hage/Rå toggle
- Tre kategoriknapper med popover og elementliste
- Valgt element vises i knappen
- Rå-modus identisk med v1
...
**Start med Fase 0. Bruk selvevalueringsprotokollen når du er ferdig.**
